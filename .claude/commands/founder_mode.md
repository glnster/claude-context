---
description: Create plane ticket and PR for experimental features after implementation
---
...
2. read `.claude/commands/plane.md` - think deeply about what you just implemented, then create a plane ticket about what you just did, and put it in 'in dev' state - it should have ### headers for "problem to solve" and "proposed solution"
