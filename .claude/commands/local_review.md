...
3. **Set up the remote and worktree**:
   ...
   - If not, add it: `git remote add USERNAME git@github.com:USERNAME`
   - Fetch from the remote: `git fetch USERNAME`
   - Create worktree: `git worktree add -b BRANCHNAME ~/wt/SHORT_NAME USERNAME/BRANCHNAME`
...
4. **Configure the worktree**:
   ...
   - Initialize thoughts: `WORKTREE/hack/init_thoughts.sh`
...
- Create worktree at `~/wt/eng-1696`
